...
| **NEXUS** 🔒 | Learning app that takes someone from zero to competent in code and AI — **22 chapters, 220 lessons**, real code execution in a sandbox, spaced repetition, XP and streaks. Built for everyone from kids to pensioners | Electron, JS | **95** |
